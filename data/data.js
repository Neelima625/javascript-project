...
// Function to update candies
async function updateCandies() {
    ...
    try {
        ...
        console.log(`Added candy to candies`);
    } catch (error) {
        console.error(`Error adding data to candies:`, error.message || error);
    }
}
